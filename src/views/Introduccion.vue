...
.curso-main-container.introduccion
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.BGIMG01.align-items-center.mb-5.p-4
      .col-md-9.col-11
      ...
      .col-md-12     
        figure
          .video
            iframe(width="560" height="315" src="https://www.youtube.com/embed/v-0KKpO_Xj0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)
